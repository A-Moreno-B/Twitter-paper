...
wcNeu_freq = pd.DataFrame.from_dict(dfNeutros.words_,orient='index', columns=('frequency'))
wcNeu_freq.to_csv('word_freq_neu.csv', Index=False)

wcPos_freq = pd.DataFrame.from_dict(dfPositivos.words_,orient='index', columns=('frequency'))
wcPos_freq.to_csv('word_freq_pos.csv', Index=False)

wcNeg_freq = pd.DataFrame.from_dict(dfNegativos.words_,orient='index', columns=('frequency'))
wcNeg_freq.to_csv('word_freq_neg.csv', Index=False)
